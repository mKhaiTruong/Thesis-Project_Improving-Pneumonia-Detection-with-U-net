...
class Covid_CT_Scan_3_Config(BaseConfig):
    def __init__(self):
        super().__init__()
        
        self.all_labels  = ['background', 'pneu']
        self.only_labels = ['pneu']
        self.parentDir = r"D:\Downloads\COVID-19 CT scans 3"
        ...
        # Below is the output dataset from U-net
        # self.refinementMasksDir = sorted(glob(
        #     pathname   = os.path.join(self.parentDir, 'unet_unetpp_b3_10epochs_masks', '*.png'), 
        #     recursive  = True
        # ))
